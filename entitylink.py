...
def getEntity(mention,entityname):
	...
	if mention == '':
		...
		conn= MySQLdb.connect(host='localhost',user='root',passwd = '123456',db ='entitylinkdb',charset='utf8')
		cur = conn.cursor()
...
def getPairPath(entitypair):
	...
	"mysql6:a<-()->b"
	patharray = []
	conn= MySQLdb.connect(host='localhost',user='root',passwd = '123456',db ='entitylinkdb',port=3306,charset='utf8')
	cur = conn.cursor()
